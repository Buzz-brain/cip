...
export const OnboardingContent: React.FC<{ step?: 'one' | 'two' }> = ({ step = 'one' }) => {
  return (
    <div className="w-full min-h-full">
      <header className="sticky top-0 z-10 w-full border-b border-[#37291f] bg-[#0d0501]">
        <div className="container flex h-16 items-center justify-between px-4 sm:px-8">
          ...
          <nav className="flex items-center gap-8">
            <div className="flex items-center gap-6">
              <a href="#" className="text-sm font-medium leading-5 text-slate-400 hover:text-white">Docs</a>
              <a href="#" className="text-sm font-medium leading-5 text-slate-400 hover:text-white">FAQ</a>
            </div>

            <Button className="h-10 px-4 bg-[#ff6600] hover:bg-[#ff7700] font-bold text-white text-sm leading-[21px] rounded-lg">Connect Wallet</Button>
          </nav>
        </div>
      </header>
      ...
      <main className="relative flex-1 p-4 sm:p-8">
        ...
        <section className="relative py-6">
          <div className="container max-w-screen-xl px-0 sm:px-2">
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20">
              <div className="w-full md:max-w-2xl flex-1 flex flex-col items-start gap-6 md:gap-8">
                ...
                <div>
                  <h1 className="font-bold text-3xl sm:text-4xl md:text-[48px] text-white mt-3 mb-2 leading-tight">
                    Secure Your Legacy
                ...
                <div className="flex w-full flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                  <Button className="w-full sm:w-auto h-12 gap-2 overflow-hidden rounded-lg bg-[#ff6600] px-6 sm:px-8 shadow-[0px_4px_6px_-4px_#3b82f633,0px_10px_15px_-3px_#3b82f633] hover:bg-[#ff6600]/90">
                  ...
                  <Button variant="outline" className="w-full sm:w-auto h-12 gap-2 rounded-lg border-[#554733] bg-transparent px-6 sm:px-8 hover:bg-[#554733]/10">
                    <div className="relative h-6 w-5">
              ...
              <div className="w-full md:h-[420px] flex-1 mt-6 md:mt-0">
                        ...
                        <CardContent className="flex flex-col gap-3 p-0">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-[#b8a494]">Start here</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
