...
export const ConfirmInactivityOraclePlan = (): JSX.Element => {
  ...
  const handleConfirm = () => {
    // Navigate to central Review & Confirm page — final submit happens there.
    const navState = {
      inactivityState: {
        inactivityDays,
        chosenMethods,
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 mb-8">
        ...
        <div className="w-full md:w-[35%] border-2 border-[#FF660033] rounded-2xl p-6 bg-[#FF66001A]">
          ...
          <Button
            ...
            className="inline-flex w-full mt-5 items-center gap-2 px-7 py-6 bg-[#ff6600] hover:bg-[#ff6600]/90 rounded-lg font-bold text-white text-base text-center leading-6"
          >
