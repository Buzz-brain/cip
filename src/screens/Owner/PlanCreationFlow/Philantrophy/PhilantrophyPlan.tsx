      ...
      <main className="w-full max-w-[768px] mx-auto px-6 py-10 flex flex-col gap-10">
        <section className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-[#ff6600] text-sm leading-5">
              Inheritance Protocol
            </span>
          </div>

          <h1 className="font-bold text-white text-[35px] leading-[44px]">
            Philanthropy Plan Setup
          </h1>

          <p className="font-normal text-[#b9ae9d] text-base leading-6">
        ...
        <Card className="bg-[#27221c] border border-[#392f28] rounded-xl p-6">
          ...
          <div className="flex items-start justify-between text-sm">
            <span className="font-medium text-white flex-1 text-center">
              Add Charities
            </span>
            <span className="font-medium text-white flex-1 text-center">
              Allocate Funds
        ...
        <section className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <p className="font-normal text-[#8b7b64] text-sm leading-5">
              ...
              >
                <CardContent className="p-5 flex flex-col gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-white text-base leading-6 mb-1">
                        {charity.name}
                      </h3>
                      <div className="flex items-center gap-2">
                        <div
                        ...
                        />
                        <span className="font-normal text-[#8b7b64] text-xs">
                          {charity.network}
                        </span>
                      </div>
                    </div>
              ...
              <div className="flex-1 flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between p-4 bg-[#181511] rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold text-[#8b7b64] text-sm">
                        Unallocated (Remaining)
                      </span>
                      <span className="font-normal text-[#695a47] text-xs">
                        Returns to main estate
                      </span>
                    </div>
                  </div>
                  <span className="font-bold text-[#8b7b64] text-lg">
                    {unallocated}.00%
                  </span>
                </div>
              </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex flex-col gap-1">
                  <span className="font-bold text-[#221810] text-base leading-6">
                    I confirm these charity wallets are correct.
                  </span>
                  <p className="font-normal text-[#3b251e] text-sm leading-5">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[#3b251e]">
                <Button
                  ...
                  className="font-bold text-[#221810] text-base hover:bg-[#3b251e]/10 h-12 px-6"
                >
                  Cancel Setup
                </Button>
                ...
                <Button
                  onClick={() => navigate("/")}
                  className="flex-1 font-bold text-white text-base bg-[#3b251e] hover:bg-[#3b251e]/90 h-12 px-6 gap-2"
                >
                ...
                <Button
                  ...
                  className="flex-1 font-bold text-white text-base bg-[#ff6600] hover:bg-[#ff6600]/90 disabled:opacity-50 disabled:pointer-events-none h-12 px-6 gap-2"
                >
