      ...
      <main className="flex-1 flex flex-col items-center px-4 py-12">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-[#ff66001a] border-[#ff660033] text-[#ff6600] hover:bg-[#ff66001a] font-bold text-xs rounded-full px-3 py-1">
                    <img
                      className="w-3 mr-1"
                ...
                <p className="font-normal text-[#9dabb9] text-[13.9px] tracking-[0] leading-[21px]">
                ...
                <Card className="bg-[#181411] border-[#54463b]">
                  <CardContent className="p-[21px] flex flex-col gap-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1">
                        ...
                        <Input
                          ...
                          className="bg-[#27211c] border-[#54463b] text-white font-normal text-sm"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1">
                        <Label
                          ...
                          className="font-medium text-white text-[13.6px] tracking-[0] leading-[21px]"
                        >
                    ...
                    <Button
                      variant="outline"
                      className="w-fit bg-[#27211c] border-[#54463b] text-[#ff6600] hover:bg-[#27211c] hover:text-[#ff6600] font-bold text-sm"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-1">
                    <Label
                      ...
                      className="font-medium text-white text-[13.5px] tracking-[0] leading-[21px]"
                    >
                    ...
                    <div className="flex items-center gap-10 bg-[#181411] border border-[#54463b] rounded-lg px-[13px] py-[21px]">
                      <span className="font-medium text-white text-[13.8px] tracking-[0] leading-5">
                        Recovery requires
                      </span>
                      <span className="font-medium text-white text-[13.8px] tracking-[0] leading-5">
                        of guardians
                  ...
                  <Alert className="bg-[#8a591e1a] border-[#af5a1e4d]">
                    <AlertDescription className="flex flex-col gap-[6.5px]">
                      <span className="font-bold text-white text-sm tracking-[0] leading-[17px]">
                        Security note
                      </span>
                      <p className="font-normal text-[#9dabb9] text-xs tracking-[0] leading-[19px]">
