...
export const ChoosePlanType = (): JSX.Element => {
    ...
    const displayedPlanTypes = (() => {
            ...
            if (supportedBackendTypes.length === 0) return [];
                ...
                <div className="w-full max-w-6xl">
                    <div className="flex flex-col gap-8">
                        ...
                        {supportedBackendTypes === null ? (
                            ...
                            displayedPlanTypes.length === 0 ? (
                                <div className="p-6 rounded-lg bg-[#27231C] border-2 border-[#54493B]">
                                    <h3 className="text-lg font-semibold text-white mb-2">No plan types available</h3>
