    ...
    <div className="w-full max-w-2xl">
      <div className="border-2 border-[#EC13134D] rounded-xl bg-[#221010]">
        ...
        <div className="p-12 pb-3">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="text-center">
                ...
                <div className="text-xs text-[#CFBABA] tracking-wider">Days</div>
              </div>
              <div className="text-center">
                <div className="text-4xl flex items-center justify-center h-20 border border-[#EC131333] bg-[#00000066] rounded-lg font-bold mb-2">
                  {String(timeRemaining.hours).padStart(2, "0")}
                </div>
                <div className="text-xs text-[#CFBABA] tracking-wider">Hours</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-xs text-[#CFBABA] tracking-wider">Mins</div>
              </div>
              <div className="text-center">
                <div className="text-4xl flex items-center text-[#EC1313] justify-center h-20 border border-[#EC131333] bg-[#00000066] rounded-lg font-bold mb-2">
                  {String(timeRemaining.seconds).padStart(2, "0")}
                </div>
                <div className="text-xs text-[#CFBABA] tracking-wider">Secs</div>
              </div>
            </div>
          </div>
          ...
          <button
            onClick={() => {
              if (onClose) onClose(); else navigate("/owner-dashboard");
            }}
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <button onClick={() => navigate("/view-plan-history")} className="bg-transparent border border-[#CFBABA33] hover:border-gray-600 text-[#CFBABA] py-3 rounded-lg font-medium transition">
              View Plan Details
            </button>
          </div>
        </div>
      ...
      <div className="p-6 text-left">
        <p className="text-sm leading-relaxed flex items-start gap-3">
          ...
          <span className="text-[#CFBABA]">
            Failure to respond within the timeframe above will result in the permanent transfer of assets to your designated beneficiaries via Smart Contract execution. This action cannot be undone once the timer reaches zero.
          </span>
        </p>
      </div>
    </div>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center text-white [font-family:'Manrope',Helvetica]">
        ...
        <div className="relative w-full max-w-2xl mx-4 pointer-events-auto">
          <div className="border-t-4 border-[#EC1313] rounded-lg p-6 bg-[#2E261C] relative">
            <button aria-label="Close critical alert" onClick={() => onClose && onClose()} className="absolute top-3 right-3 text-[#B9B09D] hover:text-white">✕</button>
            {inner}
          </div>
        </div>
      </div>
    ...
    <div className="flex flex-col w-full min-h-screen bg-[#221010] text-white [font-family:'Manrope',Helvetica]">
      <header className="w-full h-[61px] flex items-center justify-between px-10 bg-[#0d0501] border-b border-[#393028]">
        ...
        <nav className="flex items-center gap-8">
          ...
          <a href="#" className="text-gray-400 hover:text-gray-300 text-sm font-semibold">
            My Plans
          </a>
