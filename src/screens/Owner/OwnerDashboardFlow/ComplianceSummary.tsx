      ...
      <div className="px-8 py-8 max-w-6xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm mb-6">
            <span className="font-normal text-[#8b7b64]">
              Home
            </span>
          ...
          <div className="flex items-start justify-between gap-8">
            ...
            <Button className="bg-[#3d2a23] hover:bg-[#4a3a2a] text-[#ff6600] border border-[#ff6600] font-bold text-sm px-6 py-2 flex items-center gap-2 transition-colors">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          <Card className="bg-[#181511] border border-[#392f28] rounded-xl">
            <CardContent className="p-6 flex flex-col gap-3">
              ...
              <p className="font-normal text-[#2ccd2c] text-xs">
                +5% vs Global Avg
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#181511] border border-[#392f28] rounded-xl">
            <CardContent className="p-6 flex flex-col gap-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-[#8b7b64] text-xs bg-[#27221c] px-2 py-1 rounded">
                  public
                </span>
              </div>
              <p className="font-bold text-white text-4xl">
        ...
        <Card className="bg-gradient-to-r from-[#3d2a23] to-[#2a1f18] border-l-4 border-l-[#ff3b30] rounded-xl mb-8">
          <CardContent className="p-6 flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="font-normal text-[#b9ae9d] text-sm mb-4">
              ...
              <Button className="bg-[#ff6600] hover:bg-[#ff6600]/90 text-white font-bold text-sm px-6 py-2 flex items-center gap-2 transition-colors">
                <DownloadIcon className="w-4 h-4" />
                Download Template
              </Button>
            </div>
              ...
              <CardContent className="p-6 flex flex-col gap-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-normal text-[#8b7b64] text-sm mb-3">
                      Your designated executor has not completed KYC verification. This may delay asset release.
                    </p>
                    <button className="font-bold text-[#ff6600] hover:text-[#ff6600]/80 text-sm transition-colors">
                      Send Reminder
                    </button>
                  </div>
                </div>
        ...
        <div className="flex items-center justify-between gap-4 pt-8 border-t border-[#392f28]">
          <Button
            ...
            className="px-8 py-3 bg-[#27221c] border border-[#392f28] text-white hover:bg-[#2d251f] font-bold text-base rounded-lg transition-colors"
          >
            Back
          </Button>

          <Button className="px-8 py-3 bg-[#ff6600] hover:bg-[#ff6600]/90 text-white font-bold text-base rounded-lg transition-colors">
