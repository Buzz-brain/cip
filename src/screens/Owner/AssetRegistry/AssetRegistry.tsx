      ...
      <header className="bg-[#1a1410] border-b border-[#3a2f1e] px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-[#8b7664] hover:text-white text-sm">
              Dashboard
            </a>
            <a href="#" className="text-[#8b7664] hover:text-white text-sm">
              Trusts
                ...
                <Card className="bg-[#1a1410] border-[#3a2f1e]">
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <label className="text-[#8b7664] text-sm">
                          MPC Approval Lock
                        </label>
                        <button
                      ...
                      <p className="text-[#ff6600] text-xs bg-[#ff66001a] border border-[#ff66004d] rounded p-2">
            ...
            <div className="space-y-4">
              <Card className="bg-[#1a1410] border-[#3a2f1e]">
                <CardContent className="p-6 space-y-4">
                  ...
                  <Button className="w-full bg-[#ff6600] hover:bg-[#ff6600]/90 text-white font-bold gap-2">
