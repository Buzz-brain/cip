        ...
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-8">
            ...
            <nav className="flex gap-6 text-sm">
              ...
              <button className="text-gray-400 hover:text-white">Plans</button>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <button className="bg-[#2a2420] border border-[#3a3430] px-4 py-2 rounded-lg text-sm flex items-center gap-2">
                    ⚙️ Filter
                  </button>
                </div>
              </div>
              ...
              <div className="bg-[#2a2420] border border-[#3a3430] rounded-xl overflow-hidden">
                <table className="w-full">
                  ...
                  <tbody>
                    <tr
                      className="border-b border-[#3a3430] hover:bg-[#3a3430] cursor-pointer"
                      onClick={() => navigate("/plan/402")}
                    >
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-[#3a3430] rounded-full flex items-center justify-center text-sm">
                            JD
                          </div>
                          <div>
