    ...
    <header className="relative z-20 bg-[#0d0501] backdrop-blur-xl border-b border-zinc-800 sticky top-0 [font-family:'Manrope',Helvetica]">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <nav className="flex items-center gap-8">
          ...
          <a href="#plans" className="[font-family:'Manrope',Helvetica] text-white text-sm hover:text-white transition-colors">My Plans</a>
          <a href="#tasks" className="[font-family:'Manrope',Helvetica] text-white text-sm hover:text-white transition-colors">Executor Tasks</a>
        </nav>

        <div className="flex items-center gap-4">
          <button className="w-8 h-8 rounded-lg hover:bg-[#3a3430] flex items-center justify-center">
