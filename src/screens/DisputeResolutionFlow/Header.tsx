    ...
    <header className="relative z-20 bg-[#0d0501] backdrop-blur-xl border-b border-zinc-800 sticky top-0">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <nav className="flex items-center gap-8">
          ...
          <a href="#plans" className="text-white text-sm hover:text-white transition-colors">My Plans</a>
          <a href="#tasks" className="text-white text-sm hover:text-white transition-colors">Executor Tasks</a>
        </nav>
