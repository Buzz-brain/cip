...
export const ComplianceSummary = (): JSX.Element => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0d0501]">
      <header className="sticky top-0 flex items-center justify-between px-8 py-4 bg-[#0d0501] border-b border-[#392f28]">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate("/overview")}
            className="w-8 h-8 flex items-center justify-center bg-[#ff6600] rounded-lg hover:bg-[#ff6600]/90 transition-colors"
          >
        ...
        <nav className="flex items-center gap-8">
          <button className="[font-family:'Manrope',Helvetica] font-normal text-[#8b7b64] hover:text-white text-sm transition-colors">
            Dashboard
          </button>
          <button className="[font-family:'Manrope',Helvetica] font-normal text-[#8b7b64] hover:text-white text-sm transition-colors">
            Inheritance Plans
          </button>
          <button className="[font-family:'Manrope',Helvetica] font-bold text-white text-sm">
            Legal Checker
          </button>
          <button className="[font-family:'Manrope',Helvetica] font-normal text-[#8b7b64] hover:text-white text-sm transition-colors">
            Settings
