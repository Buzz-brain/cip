                ...
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    {["Active", "Pending", "Triggered"].map((status) => (
                      <button
                        key={status}
                        className="px-4 py-2 rounded-lg text-[#B9B09D] hover:bg-[#2a1f10] [font-family:'Noto_Sans',Helvetica] text-sm"
                      >
                        {status}
                      </button>
                    ))}
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-[#3a2f1e]">
                          <th className="text-left py-3 px-4 [font-family:'Noto_Sans',Helvetica] font-medium text-[#B9B09D] text-xs uppercase tracking-wider">
                            Plan ID & Chain
                          </th>
                          <th className="text-left py-3 px-4 [font-family:'Noto_Sans',Helvetica] font-medium text-[#B9B09D] text-xs uppercase tracking-wider">
                            Beneficiary
                      ...
                      <tbody>
                        {plans.map((plan) => (
                          <tr
                            key={plan.id}
                            className="border-b border-[#393028] hover:bg-[#0d0b08] transition-colors"
                          >
                            ...
                            <td className="py-4 px-4">
                              <div>
                                <div className="[font-family:'Space_Grotesk',Helvetica] text-white text-sm">
                                  {showValues ? plan.assets : "••••••"}
                                </div>
                                <div className="[font-family:'Noto_Sans',Helvetica] text-[#B9B09D] text-xs">
                                  {plan.assetsDetail}
                                </div>
                              </div>
                            </td>
                  ...
                  <div className="flex items-center justify-between pt-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button className="w-8 h-8 rounded border border-[#B9B09D] hover:bg-[#2a1f10] flex items-center justify-center">
